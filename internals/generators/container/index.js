...
module.exports = {
  ...
  actions: (data) => {
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: '../../app/containers/{{properCase name}}/redux/actions.js',
      ...
      actions.push({
        type: 'add',
        path: '../../app/containers/{{properCase name}}/redux/constants.js',
      ...
      actions.push({
        type: 'add',
        path: '../../app/containers/{{properCase name}}/redux/selectors.js',
      ...
      actions.push({
        type: 'add',
        path: '../../app/containers/{{properCase name}}/redux/reducer.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: '../../app/containers/{{properCase name}}/redux/saga.js',
